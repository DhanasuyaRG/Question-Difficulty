  ...
  public static void main(String[] args) {  
    try {
      ...
      while (myReader.hasNextLine()) {
        ...
        // System.out.println("Diff "+difficulty_basedOnManualDifficulty+" "+difficulty_basedOnTime+" "+difficulty_basedOnChangesOrCompilations+" "+difficulty_basedOnHints+" "+difficulty_basedOnFeedback+" "+difficulty_basedOnMarks);
